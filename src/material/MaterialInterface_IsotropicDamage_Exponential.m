...
%
%% Class definition
classdef MaterialInterface_IsotropicDamage_Exponential < MaterialInterface_IsotropicDamage       
    %% Constructor method
    methods
        %------------------------------------------------------------------
        function this = MaterialInterface_IsotropicDamage_Exponential(parameters, penal)
